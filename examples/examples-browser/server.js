...
app.get('/', (req, res) => res.redirect('/face-recognition-testing'))
...
app.get('/face-recognition-testing', (req, res) => res.sendFile(path.join(viewsDir, 'webcamFaceExpressionRecognition.html')))
